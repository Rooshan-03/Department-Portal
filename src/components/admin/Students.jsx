...
const Students = () => {
  ...
  useEffect(() => { getAllStudents(token, dispatch); }, [token, dispatch]);
  ...
  return (
    <div className="p-8 bg-[#f8fafc] min-h-screen font-sans text-[#1e293b]">
      ...
      <div className="flex gap-6 mb-8">
        <Stat box={Students.length} label="TOTAL STUDENTS" icon="👥" color="text-blue-600" bg="bg-blue-50" />
        <Stat box="8" label="ON LEAVE" icon="📅" color="text-orange-600" bg="bg-orange-50" />
        <Stat box="12" label="NEW COMMERS" icon="👤" color="text-green-600" bg="bg-green-50" />
      </div>
